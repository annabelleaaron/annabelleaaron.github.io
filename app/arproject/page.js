        ...
        <section className="bg-white min-h-screen">
          ...
          <div className="p-5 flex flex-col md:flex-row items-center max-w-6xl mx-auto">
            <div className="w-full md:w-1/2 lg:w-1/3 md:py-10">
              <Image src="/portfolio/p1.gif" className="gif-size" alt="Gif showing how the Augmented Reality appears"/>
            </div>
          ...
          <div className="p-5 flex flex-col md:flex-row items-center max-w-6xl mx-auto">
            <div className="w-full md:w-1/2 lg:w-1/3 md:py-10">
              <Image src="/portfolio/p2.gif" className="gif-size" alt="Gif showing the interactivity between the user and the sphere"/>
            </div>
            <div className="w-full md:w-1/2 lg:w-2/3 pt-2 md:py-10 ">
          ...
          <div className="p-5 flex flex-col md:flex-row items-center max-w-6xl mx-auto">
            <div className="w-full md:w-1/2 lg:w-1/3 md:py-10">
              <Image src="/portfolio/p3.gif" className="gif-size" alt="Gif showing the interactivity when the user taps on the sphere"/>
            </div>
            <div className="w-full md:w-1/2 lg:w-2/3 pt-2 md:py-10 ">
